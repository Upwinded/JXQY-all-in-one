...
#define SDL_JAVA_PREFIX                               upwinded_jxqy_allinone		//org_libsdl_app
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    register_methods(env, "upwinded/jxqy/allinone/SDLActivity", SDLActivity_tab, SDL_arraysize(SDLActivity_tab));
    register_methods(env, "upwinded/jxqy/allinone/SDLInputConnection", SDLInputConnection_tab, SDL_arraysize(SDLInputConnection_tab));
    register_methods(env, "upwinded/jxqy/allinone/SDLAudioManager", SDLAudioManager_tab, SDL_arraysize(SDLAudioManager_tab));
    register_methods(env, "upwinded/jxqy/allinone/SDLControllerManager", SDLControllerManager_tab, SDL_arraysize(SDLControllerManager_tab));
...
int Android_JNI_ShowMessageBox(const SDL_MessageBoxData *messageboxdata, int *buttonid)
{
    ...
    mid = (*env)->GetMethodID(env, clazz, "messageboxShowMessageBox", "(ILjava/lang/String;Ljava/lang/String;[I[I[Ljava/lang/String;[I)I");
