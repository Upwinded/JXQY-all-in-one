...
// contains bin/<platform>, assets/engine, assets/common and the bootstrap
// resource index, but no playable resource packs. Online self-update stages
// the current platform's bin directory together with engine and common. The
// updater switches all three and leaves save/playable resources alone.
